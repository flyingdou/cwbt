App({
  ...
  constant: {
    ...
    base_req_url_backup_1: 'http://192.168.0.106:8080/cwbt/api/cwbtMP/',
    base_req_url_backup: 'https://cwbt.castlc.cn/cwbt/test/login?url=http://47.92.163.156:8080/cwbt/api/cwbtMP/',
